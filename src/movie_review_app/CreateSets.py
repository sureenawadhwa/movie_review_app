...
def createLexicon():
    ...
    p = "/Users/sureenawadhwa/Desktop/movie_review_app/src/movie_review_app/DataSets/NewReviews/"+movieName
...
with open("/Users/sureenawadhwa/Desktop/movie_review_app/src/movie_review_app/Pickles/Train.pickle",'wb') as s:
    pickle.dump(train,s)   
with open("/Users/sureenawadhwa/Desktop/movie_review_app/src/movie_review_app/Pickles/Test.pickle",'wb') as s:
    pickle.dump(test,s) 
with open("/Users/sureenawadhwa/Desktop/movie_review_app/src/movie_review_app/Pickles/BOW.pickle",'wb') as s:
    pickle.dump(BOW,s) 
